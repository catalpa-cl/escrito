...
implements Constants
{
			...
			throws Exception
	{
		...
		System.out.println("instanceId2TextMap: "+instanceId2TextMap.size());
		ClusterUtils.writeClusterAssignments(aContext,
				NUMBER_OF_CLUSTERS, trainOutcomeValues, copyTrainData, clusterMap, instanceId2TextMap, mostFrequentClassPerCluster);
	}
