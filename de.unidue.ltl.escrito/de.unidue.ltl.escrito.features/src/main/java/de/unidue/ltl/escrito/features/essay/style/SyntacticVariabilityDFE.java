package de.unidue.ltl.edu.scoring.features.essay.style;
...
public class SyntacticVariabilityDFE 
	...
	implements FeatureExtractor
{
        ...
        throws TextClassificationException
    {
        ...
        featList.add(new Feature(SYNTAX_TYPE_RATIO_PHRASELEVEL, getRatio(fdPhraseLevel)));
        featList.add(new Feature(SYNTAX_TYPE_RATIO_POSLEVEL, getRatio(fdPosLevel)));
        featList.add(new Feature(SYNTAX_TYPE_RATIO_SENTENCELEVEL, getRatio(fdSentenceLevel)));
        featList.add(new Feature(PAIRWISE_SYNTACTIC_SIMILARITY_PHRASELEVEL, similarityPhraseLevel));
        featList.add(new Feature(PAIRWISE_SYNTACTIC_SIMILARITY_POSLEVEL, similarityPosLevel));
        featList.add(new Feature(PAIRWISE_SYNTACTIC_SIMILARITY_SENTENCELEVEL, similaritySentenceLevel));
