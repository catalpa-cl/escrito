...
public class TaskKLDivergence
extends  KLDivergence_Base
{
			...
			throws TextClassificationException
	{
		...
		result.add(new Feature(TASK_TOKEN_KL_DIVERGENCE, getTokenDivergence(jcas,tokens,backGroundTokens), FeatureType.NUMERIC));
		// TODO, aktuell haben wir keine POS tags!
		result.add(new Feature(TASK_POS_KL_DIVERGENCE, getPOSDivergence(tokens,backGroundTokens), FeatureType.NUMERIC));
		Collection<Sentence> sentences = JCasUtil.select(jcas, Sentence.class);
		result.add(new Feature(TASK_BIGRAM_KL_DIVERGENCE, getNgrammDivergence(sentences, backGroundSentences, 2), FeatureType.NUMERIC));
		result.add(new Feature(TASK_TRIGRAM_KL_DIVERGENCE, getNgrammDivergence(sentences, backGroundSentences, 3), FeatureType.NUMERIC));
		return result;
	}
