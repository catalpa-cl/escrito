...
public class WordWeb1TFrequencyDFE
	...
	implements FeatureExtractor
{
			...
			throws TextClassificationException
	{
		...
		featList.add(new Feature(AVG_TOKEN_WEB1TFREQUENCY, avgWordFrequency));
		featList.add(new Feature(MEDIAN_TOKEN_WEB1TFREQUENCY,calcMedian(frequencies)));
		return featList;
	}
