		...
		implements FeatureExtractor
{
	...
	// TODO: If the Lemma is N (therefore valid uppercase) itself the approach
	// fails
	@Override
			...
			throws TextClassificationException
	{
		...
		for (Sentence s : JCasUtil.select(jcas, Sentence.class)) {
			...
			for (Token t : JCasUtil.selectCovered(Token.class, s)) {
				...
				// TODO: second " should be ignored
				// if there is a quotation capitalization will be ignored
				// for the next word
				...
				// if the first token in a sentence or a noun is written with
				// lower case
...
//								||isN(t)
				...
				// Capitalization is
				// ignored if the word is the first Word in the text or if it
				// occurs after quotation marks
...
//TODO: overthink this!!!
		...
		return new Feature(NR_OF_SPELLINGMISTAKES, ratio).asSet();
	}
