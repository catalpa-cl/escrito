...
public class SubstantivierungExtractorTest extends EssayGradingTestBase {
	...
	public void SubstantivierungFeatureExtractorTest() throws Exception {
		...
		SubstantivierungExtractor extractor = FeatureUtil.createResource(
				SubstantivierungExtractor.class,
				SubstantivierungExtractor.PARAM_SUFFIXES_FILE_PATH,"src/main/resources/lists/de/noun-forming_suffixes_de.txt",
				SubstantivierungExtractor.PARAM_UNIQUE_EXTRACTOR_NAME,"SubstantivierungExtractor"
		);
